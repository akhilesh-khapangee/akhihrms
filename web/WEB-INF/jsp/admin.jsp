        ...
        <header class="header">
            ...
            <nav class="nav">
                <ul>
                    ...
                    <li><a href="admin_leave_home.do">LEAVE MANAGEMENT SYSTEM</a></li>
        ...
        <div class="body_wrapper">
            <div class="body_home">
                <div class="welcome_div"><h1>Welcome </h1>
                     <p><font color="yellow"><b>${adminHome}</b></font></p>
                    <p>Welcome <b><font color="yellow">"<% out.println(session.getAttribute("user"));%></font></b>
                        to Admin home. You have been successfully logged in to the system....
                    </p>
                </div>
