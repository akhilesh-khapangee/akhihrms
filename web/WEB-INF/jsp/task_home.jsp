        ...
        <header class="header">
            ...
            <nav class="nav">
                <ul>
                    ...
                    <li><a href="employee_my_tasks.do">View assigned tasks</a></li>
            ...
            <div class="body_home">
                <div class="left_container">
                    ...
                    <div>
                        <ul>
                            <li><a href="employee.do">Home</a></li>
                            <li><a href="employee_my_tasks.do">My tasks</a></li>
                        </ul>
                    </div>
                </div>
                <div class="right_container">
                    <div class="link_div"><h3>Welcome</h3></div>
                    <div class="form"><p>Welcome to <span style="color:#F00;text-decoration:underline;">Task Management System.</span></p>
